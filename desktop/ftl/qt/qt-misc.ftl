...
qt-misc-speedrun-study-topic = Study a CFA topic...
qt-misc-speedrun-study-topic-empty = No cards found for that topic. Tag cards with cfa::topic::* or map their tags on the dashboard.
